...
public abstract class XMLCommand extends Command {
	 ...
	 *
	 * @return error code {@link com.ckfinder.connector.configuration.Constants.Errors} or
	 * {@link com.ckfinder.connector.configuration.Constants.Errors#CKFINDER_CONNECTOR_ERROR_NONE} if no error occurred.
	 */
	...
	/**
	 * whether <code>CurrentFolder</code> element should be added to the XML response.
	 *
	 * @return true if must.
	 */
